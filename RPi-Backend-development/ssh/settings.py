...
from utils import to_ip_address, parse_origin_from_url
...
font_dirs = ['ssh', 'static', 'css', 'fonts']
...
def get_app_settings(options):
    settings = dict(
        template_path=os.path.join(base_dir, 'ssh', 'templates'),
        static_path=os.path.join(base_dir, 'ssh', 'static'),
